...
#'
#' Kingsbury, N. (2006, September). Rotation-invariant local feature matching with complex wavelets. In 2006 14th European Signal Processing Conference (pp. 1-5). IEEE.
#'
#' @name filterbanks
NULL
